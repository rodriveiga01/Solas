...
- **Parked pill**: asking shrinks the card into a small top-right pill so you keep working; it settles green when the answer is ready — click (or `⇧⌃Space`) to expand it back.
